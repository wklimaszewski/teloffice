        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-2 col-lg-2 mb-2">
                <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal0">
                    ...
                    </div><img class="img-fluid" src="images/net_live.png" alt="Log Cabin"/>
                </div>
            </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image--><img class="img-fluid rounded mb-5" src="images/net_live.png" alt="Log Cabin"/>
