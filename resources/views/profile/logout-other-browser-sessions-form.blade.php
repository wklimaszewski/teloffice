<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Zarządzaj aktywnymi sesjami i wylogowuj je w innych przeglądarkach i urządzeniach.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Wyloguj ze innych sesji przeglądarki') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2"
                    ...
                    {{ __('Wyloguj ze wszystkich sesji') }}
                </x-jet-button>
            </x-slot>
        </x-jet-dialog-modal>
    </x-slot>
